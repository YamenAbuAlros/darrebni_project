...
// }
  ...
  static bool isArabicOrEnglishName(String name) {
    RegExp arabicPattern = RegExp(r'^[\u0600-\u06FF]+$');
    RegExp englishPattern = RegExp(r'^[a-zA-Z]+$');
    RegExp digitPattern = RegExp(r'\d');
    return (arabicPattern.hasMatch(name) || englishPattern.hasMatch(name)) &&
        !digitPattern.hasMatch(name);
  }

  static bool isArabicName(String name) {
    RegExp arabicPattern = RegExp(r'^[\u0600-\u06FF]+$');
    return arabicPattern.hasMatch(name);
  }
